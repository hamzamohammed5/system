...
المحتوى:
  ...
  ListHeader    — هيدر لوحة قائمة (عنوان + بحث + أزرار)
  PageHeader    — هيدر صفحة رئيسية (أيقونة + عنوان + subtitle)
  DetailHeader  — هيدر تفاصيل (عنوان + بطاقات + toolbar)
"""
...
class SectionHeader(QWidget):
    """هيدر قسم داخلي: شريط accent + عنوان + أزرار."""
...
class ListHeader(QFrame):
    """هيدر لوحة قائمة: عنوان + بحث + زر إضافة + أزرار."""
...
class DetailHeader(QFrame):
    """
    هيدر صفحة تفاصيل: عنوان + شارات + بطاقات إحصائية + toolbar.
    """
