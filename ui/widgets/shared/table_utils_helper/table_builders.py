"""
ui/widgets/shared/table_utils/table_builders.py
=================================================
دوال بناء الجداول المستخرجة من table_utils.py.
...
from .table_styles import (
    _table_stylesheet, _splitter_stylesheet,
...
def make_splitter_table(columns: list,
    ...
    from .table_helpers import calc_table_width
