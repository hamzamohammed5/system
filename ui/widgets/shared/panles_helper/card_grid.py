"""
ui/widgets/shared/panles_helper/card_grid.py
=============================================
...
الاستخدام:
    ...
    # أو مباشرة من list:
    grid = CardGrid.from_widgets([f1, f2, f3, f4], cols=4)
"""
...
class CardGrid(QWidget):
    """
    شبكة بطاقات بعدد أعمدة ثابت.
    البطاقات بتملأ الصفوف تلقائياً.
    """
    ...
    def __init__(self, cols: int = 4, spacing: int = 10, parent=None):
        ...
        # كل الأعمدة بنفس الوزن
        for c in range(cols):
            self._grid.setColumnStretch(c, 1)

    def add_widget(self, widget: QWidget):
        """يضيف widget في الموقع التالي."""
