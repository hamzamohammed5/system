...
def get_scroll_style(width: int = 6) -> str:
    return f"""
        ...
        QScrollBar:vertical {{
            background: transparent; width: {width}px; border-radius: {width//2}px;
        }}
        QScrollBar::handle:vertical {{
            background: {_C['border_med']}; border-radius: {width//2}px; min-height: 30px;
        }}
        QScrollBar::handle:vertical:hover {{ background: {_C['border_strong']}; }}
        QScrollBar::add-line:vertical, QScrollBar::sub-line:vertical {{ height: 0px; }}
        QScrollBar:horizontal {{
            background: transparent; height: {width}px; border-radius: {width//2}px;
        }}
        QScrollBar::handle:horizontal {{
            background: {_C['border_med']}; border-radius: {width//2}px; min-width: 30px;
        }}
