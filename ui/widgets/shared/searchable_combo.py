...
class _SearchableCombo(QWidget):
    ...
    Signals:
      item_selected(data) — يُطلق عند اختيار عنصر حقيقي
    """
    ...
    def get_selected_id(self):
        """يرجع الـ id المحدد (العنصر الثاني في tuple البيانات) أو None."""
        data = self.cmb.currentData()
        if data and data != _SEPARATOR_DATA and isinstance(data, tuple):
