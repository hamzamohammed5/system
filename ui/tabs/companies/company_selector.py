...
from ui.constants import (
    ...
    COMPANY_SELECTOR_ITEM_PAD_V, COMPANY_SELECTOR_ITEM_PAD_H, COMPANY_SELECTOR_ITEM_MIN_H,
    COMPANY_SELECTOR_MANAGE_BTN_SIZE, COMPANY_SELECTOR_MANAGE_BTN_RADIUS,
)
